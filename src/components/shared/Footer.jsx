    ...
    <footer className="bg-earth-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-bold mb-4">Centro Arte para la Paz</h3>
            <p className="text-gray-300 text-sm mb-4">
              Promoviendo el arte, la cultura y la transformación en Suchitoto desde hace más de 20 años.
            </p>
        ...
        {/* Copyright */}
        <div className="border-t border-earth-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; 2025 Centro Arte para la Paz. Todos los derechos reservados.</p>
          <p className="mt-2">Hecho con ❤️ en Suchitoto, El Salvador</p>
        </div>
      </div>
    </footer>
  );
